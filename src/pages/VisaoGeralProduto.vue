<template>
  <div class="conteudo__visaoGeralProduto">
    <div class="produtoPrincipal__visaoGeralProduto">
      <img class="imagemPrincipal__visaoGeralProduto" src="https://media-we-cdn.oriflame.com/-/media/Images/Ingredient-Library/Ingredients/lime.ashx?u=0101010000">
    ...
    <carrossel-conteudo :isProdutoSimilares="true" titulo="Produtos Similares"/>
  </div>
</template>
